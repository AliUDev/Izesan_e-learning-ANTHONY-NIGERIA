...
import ThumpsDown from '../../../../assets/images/thumps_down.png';
import ThumpsUp from '../../../../assets/images/thumps_up.png';
import UserComment from '../../../../assets/images/tutorial_comment.png';
import YellowCross from '../../../../assets/images/yellow_cross.png';
import YellowSend from '../../../../assets/images/yellow_send_btn.png';
...
function VideoTutorial() {
  ...
  return (
    <StyledBVideoTutorial>
      ...
      <StyledContent alertCountLength={alertCount.toString().length}>
        <div className="section1">
          ...
          <div
            ...
            <span className="my_alert">{alertCount}</span>
          </div>
        </div>
              ...
              <div className="ms-2 ms-md-4">
                <div className="d-flex">
                  ...
                  <div className="ms-4 ms-md-5 d-flex align-items-end">
                    ...
                    <span className="d-flex mx-1 mx-md-3 font-roboto like-count">2</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="cursor-pointer" onClick={() => setShowComment(false)}>
              <img src={YellowCross} />
            </div>
          </div>
...
const StyledContent = styled.div`
  ...
  .my_alert {
    ...
    border-radius: 50%;
    width: auto;
    height: ${(props) => props.alertCountLength * 4}px;
    padding: 5px 5px 5px 5px;
    background: #da6740;
    font: 6px / ${(props) => props.alertCountLength * 4}px Roboto;
    color: #ffffff;
    text-align: center;
  }
